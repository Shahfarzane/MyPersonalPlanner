...
class MockData {
    static func createMockTripModelData() -> [TripModel] {
        ...
        mockTrips.append(TripModel(title: "Trip to Bali!", image:#imageLiteral(resourceName: "Button-Cancel-icon"), dayModels: createmockDayModelData()))
        mockTrips.append(TripModel(title: "Mexico", image: #imageLiteral(resourceName: "Button-Cancel-icon")))
